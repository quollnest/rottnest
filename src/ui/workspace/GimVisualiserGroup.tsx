...
import { GimTestVisualiser } from "../plugin/gim/Visualiser.tsx";

export class GimVisualiserGroup implements WorkspaceGroup {
	...
	MakeGroup(data: WorkspaceProps): Array<ReactElement> {
		...
		const svisSpace = <GimTestVisualiser workspaceData={nWorkSpace}  />;
